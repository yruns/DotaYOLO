...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            # SwinMultiScale outputs list [P3, P4, P5] with channels [192, 384, 768] for swin_t
            # Store multi-scale output channels info in the module
            c2 = [192, 384, 768]  # Default for swin_t, will be updated based on variant
            args = args if args else []
        elif m is SwinIndex:
            # SwinIndex extracts a specific feature from SwinMultiScale output
